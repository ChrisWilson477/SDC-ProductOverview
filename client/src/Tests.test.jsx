...
describe('Testing Product Details and Each Sub-Component', () => {
  ...
  test('Renders Product Catgory', () => {
    expect(screen.getByText('Category: Kicks')).toBeInTheDocument();
  });
  ...
  test('Renders Style Name', () => {
    expect(screen.getByText('Style: White & White')).toBeInTheDocument();
  });
